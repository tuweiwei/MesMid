...
public class WifiService extends Service
{
	...
	public void onCreate() {
		...
		if("".equals(mSSID)) {
			Toast.makeText(this, "mSSID为空，请检查配置文件", 2000).show();
			stopSelf();
		}
			...
			if (WifiManager.WIFI_STATE_CHANGED_ACTION
				...
				if (configuration != null) {
					...
					if (!mIsWifiEnable) {
						...
						//Toast.makeText(Selftest.this, "----config不等空"+res,3000).show();
